...
function adminStub(overrides: Partial<IAdminClient>): IAdminClient {
  ...
  return {
    ...
    getTrackedAddresses: mock.getTrackedAddresses.bind(mock),
    getTrackedTokens: mock.getTrackedTokens.bind(mock),
    ...
    getExternalSighting: mock.getExternalSighting.bind(mock),
    getAlerts: mock.getAlerts.bind(mock),
    getPeers: mock.getPeers.bind(mock),
    ...
    getAuditLog: mock.getAuditLog.bind(mock),
    ...overrides,
  };
}
