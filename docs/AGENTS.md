...
- Основной каталог зон: `docs/repository-zones/zone-catalog.md`.
- Матрица маршрутизации задач: `docs/repository-zones/ownership-matrix.md`.
- Шаблон handoff между зонами: `docs/repository-zones/handoff-contract.md`.
- Шаблон intake для operator parent task: `docs/repository-zones/operator-task-intake.md`.
...
- usage doc: `/Users/imighty/Code/dxs-consigliere/docs/protocol/bsv-native-interpreter-usage.md`
- target/status doc: `/Users/imighty/Code/dxs-consigliere/docs/protocol/bsv-native-interpreter-target.md`
