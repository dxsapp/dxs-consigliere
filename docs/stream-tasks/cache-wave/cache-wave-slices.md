...
Owned paths:
- `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/cache-wave/**`
...
Expected files:
- `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/cache-wave/benchmarks/C11-memory-backend-benchmarks.md`
- `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/cache-wave/benchmarks/C13-comparative-memory-vs-azos.md`

## Audit Files

Expected files:
- `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/cache-wave/audits/A1.md`
- `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/cache-wave/audits/A2.md`

## Remediation Files

Naming convention:
- `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/cache-wave/remediation/R-<gate>-<nn>.md`
