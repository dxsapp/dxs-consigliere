...
- oracle demotion remains blocked by the explicit blind spots recorded in `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/bsv-native-interpreter-lifecycle-wave/audits/A1.md`
