Use [$execution-operator](/Users/imighty/.codex/skills/execution-operator/SKILL.md) to execute `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/bsv-native-interpreter-lifecycle-wave/master.md`.
