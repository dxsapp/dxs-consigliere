...
- `/Users/imighty/Code/dxs-consigliere/docs/admin-ui/admin-ui-product-spec.md` only if copy/contract needs sync
...
- `/Users/imighty/Code/dxs-consigliere/src/admin-ui/src/components/**`
- `/Users/imighty/Code/dxs-consigliere/docs/admin-ui/admin-ui-product-spec.md` if needed
...
At closeout add:
- `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/admin-ui-operator-utility-wave/audits/A1.md`
- `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/admin-ui-operator-utility-wave/evidence/closeout.md`
