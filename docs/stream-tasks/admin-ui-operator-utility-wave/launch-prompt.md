...
- `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/admin-ui-operator-utility-wave/master.md`
- `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/admin-ui-operator-utility-wave/slices.md`
- `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/admin-ui-operator-utility-wave/launch-prompt.md`
...
- add `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/admin-ui-operator-utility-wave/audits/A1.md`
- add `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/admin-ui-operator-utility-wave/evidence/closeout.md`
