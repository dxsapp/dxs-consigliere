...
Execute `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/legacy-convergence-program/` as a bounded convergence program.
...
- `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/legacy-convergence-program/slices.md`
