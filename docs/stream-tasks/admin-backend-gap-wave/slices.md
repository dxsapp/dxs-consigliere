...
### Outputs
- update `/Users/imighty/Code/dxs-consigliere/docs/admin-ui/admin-ui-api-map.md`
- update `/Users/imighty/Code/dxs-consigliere/docs/admin-ui/admin-ui-product-spec.md` if any screen assumptions changed
