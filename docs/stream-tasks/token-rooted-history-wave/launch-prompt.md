...
- `/Users/imighty/Code/dxs-consigliere/docs/platform-api/token-rooted-history-implementation-slices.md`

Durable ledger:
- `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/token-rooted-history-wave/master.md`
- `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/token-rooted-history-wave/slices.md`
