...
Closeout artifacts:
- `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/first-run-setup-wizard-wave/audits/A1.md`
- `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/first-run-setup-wizard-wave/evidence/closeout.md`
