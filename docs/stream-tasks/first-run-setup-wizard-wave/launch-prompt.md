...
Execute `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/first-run-setup-wizard-wave/` end-to-end as a bounded product-delivery wave.
...
- `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/first-run-setup-wizard-wave/master.md`
- `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/first-run-setup-wizard-wave/slices.md`
