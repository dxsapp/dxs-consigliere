...
- history sync productization:
  - `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/history-sync-wave/evidence/closeout.md`
- cache/runtime coupling and address-history backfill:
  - `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/cache-coupling-wave/evidence/closeout.md`
- storage growth benchmark evidence:
  - `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/consigliere-vnext/benchmarks/B5-storage-growth-benchmarks-evidence.md`
