...
- owned paths:
  - `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/consigliere-95-wave/audits/`
  - `/Users/imighty/Code/dxs-consigliere/docs/stream-tasks/consigliere-95-wave/evidence/`
- completion:
