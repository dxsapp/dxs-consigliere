...
- `docs/stream-tasks/consigliere-vnext/`

Recommended structure:
- `docs/stream-tasks/consigliere-vnext/master.md`
- `docs/stream-tasks/consigliere-vnext/audits/`
- `docs/stream-tasks/consigliere-vnext/benchmarks/`
- `docs/stream-tasks/consigliere-vnext/remediation/`
...
- Owned paths:
  ...
  - benchmark evidence under `docs/stream-tasks/consigliere-vnext/benchmarks/`
- Key outputs:
